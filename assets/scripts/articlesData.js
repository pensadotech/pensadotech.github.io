...
},
{
  ...
  imageSize: '80',
  imageSizeDetail:'50',
  description1:'The application is a memory game using <b>NodeJS</b>, <b>Express</b>, and <b>React</b>. ',
  description2:'The application falls into the definition of a single page application, and was built using several components. ',
  description3:'The application will present the cards once is loaded. Every time the user selects a card, the ',
  description4:'application will shuffle them, changing positions. As the user selects more cards, it will be ',
  description5:'harder to remember what card has been selected already. ',
  description6:'To win the game the user must select all card only one time. Selecting a card twice, the game is lost.',
  description7:'',
